...
#   end
#
# pkg:gem/nap#lib/rest/error.rb:22
module REST::Error; end

# This constant can be used to rescue only the known `Connection` error classes.
#
# pkg:gem/nap#lib/rest/error.rb:36
module REST::Error::Connection
  include ::REST::Error

  class << self
    # pkg:gem/nap#lib/rest/error.rb:37
    def class_names; end

    # pkg:gem/nap#lib/rest/error.rb:71
    def classes; end

    # pkg:gem/nap#lib/rest/error.rb:85
...
#
# pkg:gem/nap#lib/rest/error.rb:54
module REST::Error::Protocol
  include ::REST::Error

  class << self
    # pkg:gem/nap#lib/rest/error.rb:55
    def class_names; end
...
#
# pkg:gem/nap#lib/rest/error.rb:24
module REST::Error::Timeout
  include ::REST::Error

  class << self
    # pkg:gem/nap#lib/rest/error.rb:25
    def class_names; end
...
#
# pkg:gem/nap#lib/rest/request.rb:6
class REST::Request
  ...
  # pkg:gem/nap#lib/rest/request.rb:96
  def http_proxy; end

  # Configures and returns a new <tt>Net::HTTP</tt> request object
  #
  # pkg:gem/nap#lib/rest/request.rb:103
  ...
  #
  # pkg:gem/nap#lib/rest/request.rb:81
  def path; end

  # Performs the actual request and returns a REST::Response object with the response
  #
  # pkg:gem/nap#lib/rest/request.rb:174
  def perform; end

  # pkg:gem/nap#lib/rest/request.rb:85
  def proxy_env; end

  # pkg:gem/nap#lib/rest/request.rb:92
  ...
  # pkg:gem/nap#lib/rest/request.rb:150
  ...
  class << self
    ...
    # See new for options.
    #
    # pkg:gem/nap#lib/rest/request.rb:190
...
#
# pkg:gem/nap#lib/rest/response.rb:3
class REST::Response
  ...
  #
  # pkg:gem/nap#lib/rest/response.rb:29
  def initialize(status_code, headers = T.unsafe(nil), body = T.unsafe(nil)); end

  # pkg:gem/nap#lib/rest/response.rb:36
  def bad_request?; end

  # pkg:gem/nap#lib/rest/response.rb:24
  def body; end
  ...
  #
  # pkg:gem/nap#lib/rest/response.rb:42
  def success?; end
...
#
# pkg:gem/nap#lib/rest/response.rb:11
REST::Response::CODES = T.let(T.unsafe(nil), Array)

# Library version
#
# pkg:gem/nap#lib/rest.rb:10
