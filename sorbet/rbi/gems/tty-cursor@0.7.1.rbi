...
# pkg:gem/tty-cursor#lib/tty/cursor/version.rb:3
module TTY; end

# Terminal cursor movement ANSI codes
#
# pkg:gem/tty-cursor#lib/tty/cursor/version.rb:4
module TTY::Cursor
  private
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:157
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:150
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:111
  def column(n = T.unsafe(nil)); end

  # Query cursor current position
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:51
  def current; end

  # pkg:gem/tty-cursor#lib/tty/cursor.rb:97
  def cursor_backward(n = T.unsafe(nil)); end

  # pkg:gem/tty-cursor#lib/tty/cursor.rb:89
  def cursor_down(n = T.unsafe(nil)); end

  # pkg:gem/tty-cursor#lib/tty/cursor.rb:105
  def cursor_forward(n = T.unsafe(nil)); end

  # pkg:gem/tty-cursor#lib/tty/cursor.rb:81
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:86
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:102
  def forward(n = T.unsafe(nil)); end

  # Hide cursor
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:24
  def hide; end

  # Switch off cursor for the block
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:30
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:70
  def move(x, y); end
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:59
  def move_to(row = T.unsafe(nil), column = T.unsafe(nil)); end

  # Move cursor down to beginning of next line
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:125
  def next_line; end

  # Move cursor up to beginning of previous line
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:131
  def prev_line; end

  # Restore cursor position
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:45
  def restore; end
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:119
  def row(n = T.unsafe(nil)); end

  # Save current position
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:39
  def save; end

  # Scroll display down one line
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:203
  def scroll_down; end

  # Scroll display up one line
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:197
  def scroll_up; end

  # Make cursor visible
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:18
  def show; end
  ...
  # @api public
  #
  # pkg:gem/tty-cursor#lib/tty/cursor.rb:78
...
# pkg:gem/tty-cursor#lib/tty/cursor.rb:11
TTY::Cursor::CSI = T.let(T.unsafe(nil), String)

# pkg:gem/tty-cursor#lib/tty/cursor.rb:12
TTY::Cursor::DEC_RST = T.let(T.unsafe(nil), String)

# pkg:gem/tty-cursor#lib/tty/cursor.rb:13
TTY::Cursor::DEC_SET = T.let(T.unsafe(nil), String)

# pkg:gem/tty-cursor#lib/tty/cursor.rb:14
TTY::Cursor::DEC_TCEM = T.let(T.unsafe(nil), String)

# pkg:gem/tty-cursor#lib/tty/cursor.rb:10
TTY::Cursor::ESC = T.let(T.unsafe(nil), String)

# pkg:gem/tty-cursor#lib/tty/cursor/version.rb:5
