...
class Faraday::HttpCache < ::Faraday::Middleware
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:134
  def call!(env); end
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:158
  def request; end

  private

  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:309
  ...
  # entries.
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:298
  def create_response(env); end

  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:268
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:346
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:284
  def fetch(env); end
  ...
  # Returns nothing.
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:329
  ...
  # Returns nothing.
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:318
  def log_request; end
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:187
  def process(env); end

  # Internal: Should this cache instance act like a "shared cache" according
  # to the the definition in RFC 2616?
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:164
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:172
  ...
  # Returns nothing.
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:259
  ...
  # Returns nothing.
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:248
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache.rb:214
...
class Faraday::HttpCache::Strategies::BaseStrategy
  ...
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/base_strategy.rb:88
...
class Faraday::HttpCache::Strategies::ByUrl < ::Faraday::HttpCache::Strategies::BaseStrategy
  ...
  # @return [void]
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/by_url.rb:53
  def delete(url); end
  ...
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/by_url.rb:41
  ...
  # @return [void]
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/by_url.rb:19
  ...
  # @return [String]
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/by_url.rb:112
  ...
  # @return [Hash, nil]
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/by_url.rb:66
  ...
  # @return [true, false]
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/by_url.rb:81
  ...
  # @return [true, false]
  #
  # pkg:gem/faraday-http-cache#lib/faraday/http_cache/strategies/by_url.rb:97
